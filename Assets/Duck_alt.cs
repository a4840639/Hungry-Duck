...
public class Duck_alt : MonoBehaviour {
	float speed = 3f;
	Vector3 velocity;
	...
	void Start () {
		...
		game = GameObject.Find ("GameController").GetComponent<GameController_Alt>();
	}
